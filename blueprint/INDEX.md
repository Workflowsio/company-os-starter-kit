...
<!-- This is your content catalog. It helps Claude (and your team) find things fast.
     Update this when you add or move files. -->

## Company Context

| File | What it covers | Last updated |
|------|---------------|-------------|
| company/overview.md | Identity, ICP, priorities, metrics | {{date}} |
| company/team.md | Roster, structure, communication norms | {{date}} |
| company/accounts.md | Active clients, pipeline, churned accounts | {{date}} |
| company/gtm-stack.md | Tools, data flow, what's working | {{date}} |
| company/voice.md | Brand voice, tone, word choices | {{date}} |
| company/design-system.md | Colors, typography, visual style | {{date}} |
